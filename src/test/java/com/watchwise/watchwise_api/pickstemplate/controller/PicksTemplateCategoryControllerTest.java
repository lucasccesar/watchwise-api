...
class PicksTemplateCategoryControllerTest {
    ...
    @Test void shouldReturnNoContentWhenDeletingCategory() {
        assertThat(controller.deleteCategory(UUID.randomUUID(), UUID.randomUUID()).getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);
    }
}
